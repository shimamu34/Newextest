...
function RT() {
    ...
    s += `<td style="padding:4px; min-width:130px;">
            <div style="display:flex; flex-direction:column; align-items:center; gap:5px;">
                ...
                <input type="number" id="i0" class="v-in" style="display:none;">
            </div>
          </td>`;
                } else if (j === 4) { 
...
function L() {
    ...
    if (document.getElementById("i0_avg_disp")) {
        document.getElementById("i0_avg_disp").textContent = "平均値:-";
        document.getElementById("i0_avg_disp").style.color = "#a0aec0";
    }
...
function sendToTeacher() {
    ...
    if (document.getElementById('i4_min') && document.getElementById('i4_sec')) {
        ...
        const sc = document.getElementById('i4_sec').value;
        if (mn || sc) {
            enduranceVal = (mn || "0") + ":" + (sc || "00");
        }
    }
